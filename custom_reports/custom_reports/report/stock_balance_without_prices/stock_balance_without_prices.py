...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Balance Value"), "fieldname": "bal_val", "fieldtype": "Currency", "hidden" : 1, "width": 100, "options": "currency"},
		{"label": _("Opening Qty"), "fieldname": "opening_qty", "fieldtype": "Float", "width": 100, "convertible": "qty"},
		{"label": _("Opening Value"), "fieldname": "opening_val", "fieldtype": "Currency", "hidden" : 1, "width": 110, "options": "currency"},
		{"label": _("In Qty"), "fieldname": "in_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("In Value"), "fieldname": "in_val", "fieldtype": "Float", "hidden" : 1, "width": 80},
		{"label": _("Out Qty"), "fieldname": "out_qty", "fieldtype": "Float", "width": 80, "convertible": "qty"},
		{"label": _("Valuation Rate"), "fieldname": "val_rate", "fieldtype": "Currency", "hidden" : 1, "width": 90, "convertible": "rate", "options": "currency"},
